...
|---------|-------|--------|
| Interactive Setup Wizard | [#3](https://github.com/kianwoon/qa-swarm-executor/issues/3) | ✅ Implemented |
| MS Teams Integration | [#2](https://github.com/kianwoon/qa-swarm-executor/issues/2) | ✅ Implemented |
...
│   └── setup-wizard.sh         # Interactive setup launcher
│
├── setup.py                     # Python setup entry point
├── requirements-cli.txt        # CLI wizard dependencies
│
├── docs/
